var provinceList = [ {
    ...
    cityList: [{
        name: '广州市',
        areaList: ['南沙区','东山区', '荔湾区', '越秀区', '海珠区', '天河区', '芳村区', '白云区', '黄埔区', '番禺区', '花都区', '增城市', '从化市']
    }, {
        name: '韶关市',
        areaList: ['武江区', '浈江区', '曲江区', '始兴县', '仁化县', '翁源县', '乳源瑶族自治县', '新丰县', '乐昌市', '南雄市']
    }, {
        name: '深圳市',
        areaList: ['罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '盐田区', '坪山区', '龙华区', '光明区', '大鹏新区']
    }, {
        name: '珠海市',
        areaList: ['横琴新区', '香洲区', '斗门区', '金湾区']
    }, {
        name: '汕头市',
        ...
        name: '东莞市',
        areaList: ['城区片区', '水乡片区', '滨海片区', '松湖片区', '东部片区', '临深片区']
    }, {
        name: '中山市',
        areaList: ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '中山火炬高技术产业开发区', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇']
    }, {
        name: '潮州市',
    ...
    cityList: [{
        name: '成都市',
        areaList: ['简阳市', '锦江区', '天府新区', '高新区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江县', '金堂县', '双流县', '郫　县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市']
    }, {
        name: '自贡市',
    ...
    cityList: [{
        name: '市辖区',
        areaList: ['北京市','东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区']
    }, {
        name: '县',
        areaList: ['密云县', '延庆县']
    }]
},
{
    ...
    cityList: [{
        name: '市辖区',
        areaList: ['上海市','黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '南汇区', '奉贤区']
    }, {
        name: '县',
        areaList: ['崇明县']
    }]
},
{
    ...
    cityList: [{
        name: '市辖区',
        areaList: ['天津市','和平区', '宁河区', '滨海新区', '保税区', '河东区', '河西区', '南开区', '河北区', '红桥区', '塘沽区', '汉沽区', '大港区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区']
    }, {
        name: '县',
    ...
    cityList: [{
        name: '市辖区',
        areaList: ['重庆市','万州区', '大足区', '璧山区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '万盛区', '双桥区', '渝北区', '巴南区', '黔江区', '长寿区']
    }, {
        name: '县',
        areaList: ['綦江县', '潼南县', '铜梁县', '大足县', '荣昌县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠　县', '开　县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']
    }, {
        name: '市',
...
}, 
    {
        ...
        cityList: [{
            name: '贵阳市',
            areaList: ['观山湖区', '南明区', '云岩区', '花溪区', '乌当区', '白云区', '小河区', '开阳县', '息烽县', '修文县', '清镇市']
        }, {
            name: '六盘水市',
            areaList: ['钟山区', '六枝特区', '水城县', '盘　县']
        }, {
            name: '遵义市',
            areaList: ['红花岗区', '汇川区', '播州区', '遵义县', '桐梓县', '绥阳县', '正安县', '道真仡佬族苗族自治县', '务川仡佬族苗族自治县', '凤冈县', '湄潭县', '余庆县', '习水县', '赤水市', '仁怀市']
        }, {
            name: '安顺市',
        ...
        cityList: [{
            ...
            name: '红河哈尼族彝族自治州',
            areaList: ['个旧市', '开远市', '蒙自县', '屏边苗族自治县', '建水县', '石屏县', '弥勒市', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县']
        }, {
            name: '文山壮族苗族自治州',
        ...
        cityList: [{
            name: '郑州市',
            areaList: ['中原区', '二七区', '管城区', '金水区', '上街区', '惠济区', '中牟县', '巩义市', '荥阳市', '新密市', '新郑市', '登封市']
        }, {
            name: '开封市',
            areaList: ['龙亭区', '禹王台区', '顺河回族区', '鼓楼区', '南关区', '郊　区', '杞　县', '通许县', '尉氏县', '开封县', '兰考县']
        }, {
            name: '洛阳市',
    ...
    },
     {
        ...
        cityList: [{
            ...
            name: '永州市',
            areaList: ['零陵区','芝山区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道　县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县']
        }, {
            name: '怀化市',
        ...
        cityList: [{
            name: '西安市',
            areaList: ['新城区', '西咸新区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '蓝田县', '周至县', '户　县', '高陵县']
        }, {
            name: '铜川市',
        ...
        cityList: [{
            ...
            name: '天水市',
            areaList: ['秦城区', '北道区', '麦积区', '清水县', '秦安县', '甘谷县', '武山县', '张家川回族自治县']
        }, {
            name: '武威市',
    ...
    },
    {
        ...
        cityList: [{
            name: '乌鲁木齐市',
            areaList: ['天山区', '米东区', '沙依巴克区', '新市区', '水磨沟区', '头屯河区', '达坂城区', '东山区', '乌鲁木齐县']
        }, {
            name: '克拉玛依市',
        ...
        cityList: [{
            ...
            name: '保定市',
            areaList: ['竞秀区', '新市区', '莲池区', '北市区', '南市区', '满城县', '清苑县', '涞水县', '阜平县', '徐水县', '定兴县', '唐　县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易　县', '曲阳县', '蠡　县', '顺平县', '博野县', '雄　县', '涿州市', '定州市', '安国市', '高碑店市']
        }, {
            name: '张家口市',
        ...
        cityList: [{
            ...
            name: '大同市',
            areaList: ['城　区', '矿　区', '南郊区', '平城区', '新荣区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县', '左云县', '大同县']
        }, {
            name: '阳泉市',
        ...
        cityList: [{
            name: '呼和浩特市',
            areaList: ['新城区', '金川开发区', '回民区', '玉泉区', '赛罕区', '土默特左旗', '托克托县', '和林格尔县', '清水河县', '武川县']
        }, {
            name: '包头市',
        ...
        cityList: [{
            ...
            name: '无锡市',
            areaList: ['崇安区','新吴区', '南长区', '北塘区', '锡山区', '惠山区', '滨湖区', '江阴市', '宜兴市']
        }, {
            name: '徐州市',
            ...
            name: '苏州市',
            areaList: ['姑苏区', '沧浪区', '平江区', '金阊区', '虎丘区', '吴中区', '相城区', '常熟市', '张家港市', '昆山市', '吴江市', '太仓市']
        }, {
            name: '南通市',
            ...
            name: '淮安市',
            areaList: ['清河区', '淮安区', '楚州区', '淮阴区', '清浦区', '涟水县', '洪泽县', '盱眙县', '金湖县']
        }, {
            name: '盐城市',
    ...
    },
    {
        ...
        cityList: [{
            name: '合肥市',
            areaList: ['瑶海区', '巢湖市', '庐江县', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县']
        }, {
            name: '芜湖市',
            areaList: ['镜湖区', '无为县', '马塘区', '新芜区', '鸠江区', '芜湖县', '繁昌县', '南陵县']
        }, {
            name: '蚌埠市',
        ...
        cityList: [{
            name: '南昌市',
            areaList: ['东湖区', '红谷滩新区', '西湖区', '青云谱区', '湾里区', '青山湖区', '南昌县', '新建县', '安义县', '进贤县']
        }, {
            name: '景德镇市',
        ...
        cityList: [{
            ...
            name: '威海市',
            areaList: ['经济技术开发区', '环翠区', '文登市', '荣成市', '乳山市']
        }, {
            name: '日照市',
        ...
        cityList: [{
            name: '沈阳市',
            areaList: ['和平区', '沈北新区', '沈河区', '大东区', '皇姑区', '铁西区', '苏家屯区', '东陵区', '新城子区', '于洪区', '辽中县', '康平县', '法库县', '新民市']
        }, {
            name: '大连市',
        ...
        cityList: [{
            name: '长春市',
            areaList: ['高新技术开发区', '经济技术开发区', '南关区', '宽城区', '朝阳区', '二道区', '绿园区', '双阳区', '农安县', '九台市', '榆树市', '德惠市']
        }, {
            name: '吉林市',
    ...
    //  {name:'0', cityList:[  {name:'0',areaList:['0']}]},  
    {
        name: '澳门',
        cityList: [{
            name: '澳门',
 ...
 //保存省
 var provinceArraya = new Array();
 var provinceArraya1 = new Array();
 //保存市
 var cityArraya = new Array();
 var cityArraya1 = new Array();
 var cityLista; 
 var cityLista1; 
//  var provinceTaga = document.getElementById("provincea");
//  var cityTaga = document.getElementById("citya");
//  var provinceTaga1 = document.getElementById("provincea1");
//  var cityTaga1 = document.getElementById("citya1");
//  var areaTaga = document.getElementById("areaa"); 
    // for(var i=0; i<provinceList.length; i++){	
    //     var provincea = provinceList[i];	
    //     var provinceNamea = provincea.name;	
    //     provinceArraya[i]=provinceNamea;	
    //     provinceTaga.add(new Option(provinceNamea,provinceNamea));
        
    // }	
    // for(var j=0; j<provinceList.length; j++){	
    //     var provincea1 = provinceList[j];
    //     var provinceNamea1 = provincea1.name;
    //     provinceArraya1[j]=provinceNamea1;	
    //     provinceTaga1.add(new Option(provinceNamea1,provinceNamea1));	
    //     // console.log(new Option(provinceName1,j))	
    // }	 
 //选择省
 function chooseProvincea(th){	
     var indexa = th.selectedIndex-1;	
     var provinceNamea = provinceArraya[indexa];		
     for(var n=0; n<provinceList.length; n++){		
         var provicea = provinceList[n];		
         if (provicea.name == provinceNamea){			
             cityLista = provicea.cityList;			
             cityTaga.innerHTML="";			
             for(var c=0; c<cityLista.length; c++){				
                 var citya = cityLista[c];				
                 var cityNamea= citya.name;				
                 cityArraya[c] = cityNamea;				
                 cityTaga.add(new Option(cityNamea,cityNamea));				
                }			
            }		
        }	
        var cityNamea = cityArraya[0];		
        var citya1 = cityLista[0];			
        var areaLista = citya1.areaList;			
        areaTaga.innerHTML="";			
        for(var a=0; a<areaLista.length; a++){				
            var areaa = areaLista[a];				
            areaTaga.add(new Option(areaa,areaa));				
        }	
    }
    function chooseProvincea1(th){	
        var indexa = th.selectedIndex-1;	
        var provinceNamea1 = provinceArraya1[indexa];		
        for(var n=0; n<provinceList.length; n++){		
            var provicea = provinceList[n];		
            if (provicea.name == provinceNamea1){			
                cityLista1 = provicea.cityList;			
                cityTaga1.innerHTML="";			
                for(var c=0; c<cityLista1.length; c++){				
                    var citya = cityLista1[c];				
                    var cityNamea = citya.name;				
                    cityArraya1[c] = cityNamea;				
                    cityTaga1.add(new Option(cityNamea,cityNamea));				
                   }			
               }		
           }	
           var cityNamea = cityArraya1[0];		
           var citya1 = cityLista1[0];			
           var areaLista = citya1.areaList;			
           if(provinceNamea1=="北京"||provinceNamea1=="上海"||provinceNamea1=="天津"||provinceNamea1=="重庆"){
                areaLista = cityLista1[0].areaList.concat(cityLista1[1].areaList);
                cityTaga1.innerHTML="";
                for(var a=0; a<areaLista.length; a++){				
                var areaa = areaLista[a];		
                
                cityTaga1.add(new Option(areaa,areaa));				
                }
           }	
           	
       }
 //选择市
 function chooseCitya(tag){	
     var indexa2 = tag.selectedIndex;	
     var cityNamea = cityArraya[indexa2];
     for(var m=0; m<cityLista.length; m++){		
         var citya2 = cityLista[m];		
         if (citya2.name == cityNamea){			
             var areaLista = citya2.areaList;			
             areaTaga.innerHTML="";			
             for(var a=0; a<areaLista.length; a++){				
                 var areaa = areaLista[a];				
                 areaTaga.add(new Option(areaa,areaa));				
