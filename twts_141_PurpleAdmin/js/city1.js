...
},
{
 ...
 var provinceArray1 = new Array();
 var provinceArray2 = new Array();
 var provinceArray3 = new Array();
 //保存市
 var cityArray = new Array();
 var cityArray1 = new Array();
 var cityArray2 = new Array();
 var cityList; 
 var cityList1; 
 var cityList2; 
 var provinceTag1 = document.getElementById("province1");
 var cityTag1 = document.getElementById("city1");
 var provinceTag2 = document.getElementById("province2");
 var provinceTag3 = document.getElementById("province3");
//  var cityTag2 = document.getElementById("city2");
    ...
    for(var j=0; j<provinceList.length; j++){	
        ...
        provinceTag1.add(new Option(provinceName1,provinceName1));	
        // 
    }	
    for(var j=0; j<provinceList.length; j++){	
        var province2 = provinceList[j];
        var provinceName2 = province2.name;
        provinceArray2[j]=provinceName2;	
        provinceTag2.add(new Option(provinceName2,provinceName2));	
        // 
    }
    for(var j=0; j<provinceList.length; j++){	
        var province3 = provinceList[j];
        var provinceName3 = province3.name;
        provinceArray3[j]=provinceName3;	
        provinceTag3.add(new Option(provinceName3,provinceName3));	
        // 
    }	 
 //选择省
     ...
     for(var n=0; n<provinceList.length; n++){		
         ...
         if (provice.name == provinceName){			
             ...
             for(var c=0; c<cityList.length; c++){				
                 ...
                 cityTag.add(new Option(cityName,c+1));				
                }			
            }		
        }	
        ...
        for(var a=0; a<areaList.length; a++){				
            var area = areaList[a];				
            areaTag.add(new Option(area,a+1));				
        }	
    }
  
    function chooseProvince1(province){	
        console.log(province)
        if(province == ""){
            cityList1 = []
        }else{
            var provinceName1 = province;
            for(var n=0; n<provinceList.length; n++){		
                var provice = provinceList[n];		
                if (provice.name == provinceName1){			
                    cityList1 = provice.cityList;			
                    // cityTag1.innerHTML="";			
                    
                    for(var c=0; c<cityList1.length; c++){				
                        // var city = cityList1[c];				
                        // var cityName = city.name;				
                        // cityArray1[c] = cityName;				
                        // cityTag1.add(new Option(cityName,cityName));				
                       }			
                   }		
               }	
               var cityName = cityArray1[0];		
               var city1 = cityList1[0];			
               var areaList = city1.areaList;			
               if(provinceName1=="北京"||provinceName1=="上海"||provinceName1=="天津"||provinceName1=="重庆"){
                    areaList = cityList1[0].areaList.concat(cityList1[1].areaList);
                    // cityTag1.innerHTML="";
                    cityList1 = areaList
                    for(var a=0; a<areaList.length; a++){				
                    var area = areaList[a];		
                    
                    // cityTag1.add(new Option(area,area));				
                    }
               }
        }
           	return cityList1
       }
       function chooseProvince2(province){	
           console.log(province == "")
        var provinceName1 = province;
        for(var n=0; n<provinceList.length; n++){		
            var provice = provinceList[n];		
 ...
 function chooseCity(province,city){	
    ...
    //      var city2 = cityList[m];		
    //      if (city2.name == cityName){			
    //          var areaList = city2.areaList;			
    //          areaTag.innerHTML="";			
    //          for(var a=0; a<areaList.length; a++){				
    //              var area = areaList[a];				
    //              areaTag.add(new Option(area,a+1));				
