(function ($) {
    ...
    var Forms = {
        init: function () {
            ...
            //免登录做题权限
            $("input[name='nologinTopicFlag']").each(function () {
                if($(this).is(':checked')){
                    if($(this).val() == 'true'){
                        $("#saveTopicNum").hide();
                        $("input[name='topicNum']").attr("disabled", "disabled");
                    }else{
                        $("#saveTopicNum").show();
                        $("input[name='topicNum']").removeAttr("disabled");
                    }
                }
            });
            $("input[name='nologinTopicFlag']").click(function () {
                if($(this).val() == 'true'){
                    $("#saveTopicNum").hide();
                    $("input[name='topicNum']").attr("disabled", "disabled");
                    ...
                    //     data: {
                    //         "id": setId,
                    //         "nologinTopicFlag":$(this).val() == 'true' ? 1 : 0
                    //     },
            ...
            //保存试做题数
            $("#saveTopicNum").click(function () {
                var topicNum = $("input[name='topicNum']").val();
                if(topicNum == 0){
                    topicNum = 1;
                    $("input[name='topicNum']").val(topicNum);
                }
                // if (topicNum) {
            ...
            $(".chargeStu").click(
                function () {
                    ...
                    if (thisVal == "charge_stu_all") {
                        Forms.updateSet(setId, null, null, null, 1, 0, 0, 0,
                            null, null, null, null);
                    }
                    if (thisVal == "charge_stu_item") {
                        Forms.updateSet(setId, null, null, null, 0, 1, 0, 0,
                            null, null, null, null);
                    }
                    if (thisVal == "charge_stu_item_second") {
                        Forms.updateSet(setId, null, null, null, 0, 0, 1, 0,
                            null, null, null, null);
                    }
                    if (thisVal == 'charge_stu_item_class_type') {
                        Forms.updateSet(setId, null, null, null, 0, 0, 0, 1,
                            null, null, null, null);
                    }
                });
            ...
            $(".topicAudit").click(
                function () {
                    ...
                    if (thisVal == "topic_audit_yes") {
                        Forms.updateSet(setId, null, null, null, null, null, null, null, 1, 0, null, null);
                    }
                    if (thisVal == "topic_audit_no") {
                        Forms.updateSet(setId, null, null, null, null, null, null, null, 0, 1, null, null);
                    }
                });
            ...
            $(".paperAudit").click(
                function () {
                    ...
                    if (thisVal == "paper_audit_yes") {
                        Forms.updateSet(setId, null, null, null, null, null, null, null, null, null, 1, 0);
                    }
                    if (thisVal == "paper_audit_no") {
                        Forms.updateSet(setId, null, null, null, null, null, null, null, null, null, 0, 1);
                    }
                });
            //添加科目
            ...
            //         $("#subInfo").html(data);
                    ...
                    $("#subInfo").find("li").find(".setM").find("a").click(
                        function () {
                            ...
                            } else if (mana == "offline") {
                                Forms.offlineSubject($(this).attr("subId"));
                            }
                        });
                    $("#subInfo").find("li").find(".edit").find("a").click(
                        function () {
                            ...
                            if (mana == "取消") {
                                ...
                                $this.parent(".edit").prev(".setM").prev(".info").show();
                                $this.parent(".edit").prev(".setM").show();
                            }
                        });
            //     },
            //     complete: function (XMLHttpRequest, textStatus) {
        ...
        offlineSubject: function (id) {
            // $.ajax({
            //     url: rootPath + "/tikuSubject/offlineSubject",
            //     type: "get",
            //     data: {
            //         "id": id
            //     },
        ...
        delSubject: function (obj) {
            ...
            var subName = $(obj).parent().parent().find(".newSubName").val();
            var tikuName = $("#tiku").text();
            // if (subId) {
            //     $.ajax({
        ...
        updateSet: function (id, freeStuNo, freeStuTry, freeStuTryDay, chargeStuAll, chargeStuItem, chargeStuItemSecond, chargeStuItemClassType, topicAuditYes, topicAuditNo, paperAuditYes, paperAuditNo) {
            // $.ajax({
            //     url: rootPath + "/tikuSet/update",
            //     type: "post",
            //     data: {
            ...
            //         "chargeStuItemClassType": chargeStuItemClassType,
